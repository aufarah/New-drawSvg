...
try:
    ...
    msg = (
        ...
        '`pip3 install drawsvg[png]` or `pip3 install drawsvg[all]`\n'
...
class Raster:
    ...
    This type is typically generated by rasterizing a drawing.  The image can be
    saved or viewed in a Jupyter notebook.
    """
